...
public class ShopSearchActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mydb.isDbCreated() != 1) {       // samo enkrat, na zacetku

            mydb.insertShop("Rutar", "Rudnik");
            mydb.insertShop("Mercator", "Dunajska cesta 218");
            mydb.insertShop("Interspar", "BTC");

            mydb.insertProduct("banana", 0, -2, -2);
            mydb.insertProduct("jabolko", 0, -4, -2);
            mydb.insertProduct("kruh beli", 0, 3, 3);
            mydb.insertProduct("kruh črni", 0, 3.2f, 3);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Intent i = new Intent(ShopSearchActivity.this, MainActivity.class);
