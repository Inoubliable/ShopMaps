...
public class CustomSearchAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener{
    ...
    public CustomSearchAdapter(ArrayList<DataModel> data, Context context) {
