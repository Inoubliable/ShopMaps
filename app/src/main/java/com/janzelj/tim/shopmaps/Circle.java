...
public class Circle {
    ...
    static final int VERTICES_NUM = 30;

    private float circleColor[] = new float[4];
    private float vertices[] = new float[VERTICES_NUM * 3];
    ...
    public Circle(float[] center, float r, float[] color) {
